  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Total Remote Connections</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Blocked Connections</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {stats.blocked}
              </p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Suspicious Connections</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
      ...
      {recentRemoteConnections.length > 0 && (
        <div className="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-lg shadow-sm border border-orange-200 dark:border-orange-700 p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-sm text-orange-700 dark:text-orange-300 bg-orange-100 dark:bg-orange-800 px-3 py-1 rounded-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {recentRemoteConnections.map((connection) => (
              <div key={connection._id} className="bg-white dark:bg-gray-800 rounded-lg border border-orange-200 dark:border-orange-700 p-4 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    {connection.geoLocation && (
                      <div className="flex items-center gap-1">
                        <span className="text-sm">{getCountryFlag(connection.geoLocation.countryCode)}</span>
                        {getCountryRiskLevel(connection.geoLocation.countryCode) !== 'low' && (
                          <span className={cn(
                            ...
                            {getCountryRiskLevel(connection.geoLocation.countryCode)}
                          </span>
                        )}
                      </div>
                    )}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        {filteredConnections.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 dark:text-gray-400">No remote user connections found</p>
          </div>
        ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md hover:bg-gray-50 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Previous
                </button>
